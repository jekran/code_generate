...
import com.cg.swing.SingletonSwing;
...
public class SingletonDialog extends DialogWrapper {

    private String projectName;

    //swing样式类，定义在4.3.2
    private SingletonSwing singletonSwing = new SingletonSwing();

    SingletonAction action;

    public SingletonDialog(@Nullable Project project, SingletonAction action) {
        super(true);
        this.action = action;
        setTitle("单例模式"); //设置会话框标题
        setSize(600, 200);
